...
for(tp in tp.range){
  for(phi in phi.range){
    ...
    result <- result %>% add_row(gene = str_sub(drLimma$geneId, start = 5) %>% as.numeric(),
                                 method = "LimoRhyde",
                                 timepoints = tp,
                                 noise = phi,
                                 value = drLimma$P.Value)
    ...
    result <- result %>% add_row(gene = str_sub(deLimma$geneId, start = 5) %>% as.numeric(),
                                 method = "LimoRhyde",
                                 timepoints = tp,
                                 noise = phi,
